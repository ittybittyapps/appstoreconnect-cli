    ...
    @Option(
        ...
        help: ArgumentHelp(
            ...
            discussion:
                ...
                If environment variable is empty, in the incorrect format, or not found then this option will search following  directories in sequence for a private key file with the name of 'AuthKey_<api-key-id>.p8': \(ListFormatter.localizedString(byJoining: APIKeyID.searchPaths)).
