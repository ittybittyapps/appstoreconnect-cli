...
class AppStoreConnectService {
    ...
    func readCertificate(with options: ReadCertificateOptions) -> AnyPublisher<Certificate, Error> {
        let dependencies = ReadCertificateOperation.Dependencies(certificatesResponse: request)
